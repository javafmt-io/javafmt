 ...
 * {@code JavafmtFormatBenchmark}: this measures only the parse phase on the same
 * corpus sources, no print strategy axis.
 *
 * <p>The CPU profile of {@code JavafmtFormatBenchmark} pinned ~91% of benchmark-thread

 ...
 * must be safe to apply unconditionally (grind has no opt-in fixes), and must converge:
 ...
 * edit, it should emit a {@link io.github.jschneidereit.grind.Diagnostic.Warning} instead

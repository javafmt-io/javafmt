...
/**
 * Differential oracle test for {@link io.github.jschneidereit.grind.lint.FinalParameters}:
 * grind's output for every corpus file must contain zero violations of Checkstyle's
 * equivalent {@code FinalParametersCheck}.
 *
 * <p>Checkstyle's defaults match grind's scope: {@code METHOD_DEF} and {@code CTOR_DEF},

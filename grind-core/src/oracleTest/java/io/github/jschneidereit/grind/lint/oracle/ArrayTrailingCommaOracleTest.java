...
/**
 * Differential oracle test for {@link io.github.jschneidereit.grind.lint.ArrayTrailingComma}:
 * grind's output for every corpus file must contain zero violations of Checkstyle's
 * equivalent {@code ArrayTrailingCommaCheck}.
 *
 * <p>{@code alwaysDemandTrailingComma=true} matches grind's strict policy: every
 ...
 * brace is on its own line; grind goes strict because the trailing comma minimizes diff
